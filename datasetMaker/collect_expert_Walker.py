...
expert_obs_all = np.array(expert_obs_all, dtype=np.float)
expert_actions_all = np.array(expert_actions_all, dtype=np.float)

# 저장
np.savez("expert_data_walker.npz", obs=expert_obs_all, actions=expert_actions_all)
print("Saved expert_data_walker.npz:", expert_obs_all.shape, expert_actions_all.shape)
